"""CLI-level negative tests for compare plugin dual-file input validation."""
...
class TestCompareCLIDualFileValidation:
    """Validate dual-file input handling at the compare CLI layer."""
