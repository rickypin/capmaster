#!/usr/bin/env python3
"""Check detailed structure of kase_134_tcp_stream_extra table."""
...
def check_table_134():
    """Check detailed structure of kase_134_tcp_stream_extra."""
    print("=" * 120)
    print("DETAILED STRUCTURE OF public.kase_134_tcp_stream_extra")
    print("=" * 120)
    ...
    try:
        ...
        table_name = 'kase_134_tcp_stream_extra'
        ...
        cursor.execute("""
            ...
            WHERE a.attrelid = 'public.kase_134_tcp_stream_extra'::regclass
            AND a.attnum > 0 
